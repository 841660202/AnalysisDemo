...
import com.chl.pluginadapter.adapter.AnimationAdapter;
import com.chl.pluginadapter.animation.CustomAnimation;
...
public class AnimationUseActivity extends Activity {
    ...
    private void initMenu() {
        ...
        spinner
                .setItems("AlphaIn", "ScaleIn", "SlideInBottom", "SlideInLeft", "SlideInRight", "Custom");
        spinner
                .setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
